...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"http://t.me/kuclukjr_bot"}]]}' 
...
clear
    print_install "Core Xray 25.10.15 Latest Version"
...
xraycore_link="https://github.com/XTLS/Xray-core/releases/download/v25.10.15/xray-linux-64.zip"
